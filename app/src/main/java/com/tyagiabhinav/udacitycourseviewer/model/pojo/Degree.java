...
public class Degree implements Parcelable {
    ...
    protected Degree(Parcel in) {
        ...
        this.affiliates = new ArrayList<Object>();
        in.readList(this.affiliates, Object.class.getClassLoader());
        this.tracks = new ArrayList<Object>();
        in.readList(this.tracks, Object.class.getClassLoader());
    ...
    public static final Parcelable.Creator<Degree> CREATOR = new Parcelable.Creator<Degree>() {
        @Override
